    ...
    <div className="px-4 py-12 bg-background">
      <Container>
        <div className="text-center mb-12">
          <h1 className="max-w-[320px] md:max-w-[739px] mx-auto text-2xl md:text-5xl font-bold text-button-text leading-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
          {/* Card 1 */}
          <div className="bg-foreground p-8 rounded-lg shadow-sm flex flex-col items-center text-center">
            <div className="w-16 h-16 mb-6 text-cyan-400">
              <svg
                width="52.500000"
                height="60.000000"
                viewBox="0 0 52.5 60"
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop offset="0.021000" stopColor="#03EFFE"></stop>
                    <stop offset="0.293000" stopColor="#24D2FE"></stop>
                    <stop offset="0.554000" stopColor="#3CBDFE"></stop>
                    <stop offset="0.796000" stopColor="#4AB0FE"></stop>
                    <stop offset="1.000000" stopColor="#4FACFE"></stop>
                  </linearGradient>
                </defs>
                <path
                  id="Vector"
            ...
            <h2 className="md:max-w-[270px] text-base md:text-2xl font-semibold text-black mb-2 text-center">
            ...
            <div className="w-16 h-16 mb-6 text-cyan-400">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stopColor="#00F2FE"></stop>
                    <stop offset="0.020800" stopColor="#03EFFE"></stop>
                    <stop offset="0.293100" stopColor="#24D2FE"></stop>
                    <stop offset="0.553800" stopColor="#3CBDFE"></stop>
                    <stop offset="0.795600" stopColor="#4AB0FE"></stop>
                    <stop offset="1.000000" stopColor="#4FACFE"></stop>
                  </linearGradient>
                </defs>
                <path
